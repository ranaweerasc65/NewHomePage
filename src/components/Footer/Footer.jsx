      ...
      <Container>
        <Row>
          ...
          <Col lg='3'>
            <h5 className ="footer__link-title">Contact</h5>
                ...
                <ListGroupItem className="ps-0 border-0 d-flex align-items-center gap-3">
                  ...
                  <p className="mb-0 d-flex align-items-center gap-2">hod@is.ruh.ac.lk</p>
                </ListGroupItem>
          ...
          <Col lg='12' className="text-center pt-5">
            <p className="copyright">Department of Iterdisciplinary Studies - {year}, All rights are reserved.  </p>
          </Col>
